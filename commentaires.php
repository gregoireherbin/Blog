			...
			<div class="col-lg-8 px-4">
				<div class="card mb-3">
				  <div class="row no-gutters">
    				<div class="col-md-6 ">
      				<img src="img/<?= $post['picture'];?>" class="card-img" alt="...">
    				</div>
	    			<div class="col-md-6">
	    				<div class="card-body">
...
{?>	<p><strong><?= htmlspecialchars($donnees['author']).'</strong> a écrit : '.htmlspecialchars($donnees['comment']).' le  '. htmlspecialchars($donnees['comment_date']);?></p>
<?php
}
...
<!-- Formulaire d'ajout de commentaires -->
				...
				<form method="POST" action="commentaires_post.php?id_post=<?=$_GET['id']?>&page=<?=$pages-1?>">
					<label for="author" class="form-label" >Pseudo :</label>
					<input type="text" class="form-control" name="author" required><br><br>
					<label for="comments" class="form-label">Message :</label>
					<textarea name="comments" class="form-control" required></textarea><br><br>
